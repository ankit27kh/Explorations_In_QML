...
res = opt.optimize(
    ...
    lambda params: all_cost(params, X_train, y_train),
...
y_predict_train = all_predict(X_train, trained_weights)
y_predict_test = all_predict(X_test, trained_weights)
...
with open(f'new_data_/rotor/noise/direct_{use_noise}_{num_points}.pkl', 'wb') as file:
