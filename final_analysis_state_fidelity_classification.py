...
directory = "new_data_/Classification/Fidelity"
...
for file in sorted_alphanumeric(os.listdir(directory)):
    ...
    with open(path, "rb") as f:
        ...
        all_state_fidelities.append(data[9])
...
df = pd.DataFrame(
    {
        ...
        "training_costs": all_state_fidelities,
...
for data_used in [
    ...
    data_table_acc.append(data_l2_2.after_accuracy_test.max())
    data_table_f1_macro.append(data_l2_2.after_macro_f1_test.max())
    data_table_f1_weight.append(data_l2_2.after_weight_f1_test.max())
    data_table_acc.append(data_l2_4.after_accuracy_test.max())
    data_table_f1_macro.append(data_l2_4.after_macro_f1_test.max())
    data_table_f1_weight.append(data_l2_4.after_weight_f1_test.max())
    ...
    for i, data_l3_l in enumerate([data_l3_1, data_l3_2, data_l3_3, data_l3_4]):
        ...
        data_table_acc.append(data_l3_l.after_accuracy_test.max())
        data_table_f1_macro.append(data_l3_l.after_macro_f1_test.max())
        data_table_f1_weight.append(data_l3_l.after_weight_f1_test.max())
    ...
    # plt.savefig(f'new_data_/Classification/Plots/fidelities_results_{data_used.data_used.iloc[0]}.pdf', format='pdf',
...
plt.legend()
plt.tight_layout()
# plt.savefig(f'new_data_/Classification/fidelities_best_results.pdf', format='pdf', dpi=1200, bbox_inches='tight')
plt.show()
...
table_f1_macro = pd.DataFrame(table_f1_macro,
...
table_f1_weight = pd.DataFrame(table_f1_weight,
                               columns=['Type 1', 'Type 4', 'Type 5', 'Type 6', 'Type 7', 'Type 8', 'Type 2-2',
                                        'Type 2-4', 'Type 3-1', 'Type 3-2', 'Type 3-3', 'Type 3-4'],
                               index=["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", 'O', 'P'])
table_acc = pd.DataFrame(table_acc,
                         columns=['Type 1', 'Type 4', 'Type 5', 'Type 6', 'Type 7', 'Type 8', 'Type 2-2', 'Type 2-4',
